let weather = {
	"apiKey" : "39a1a2e6b6e227d118f6ab23d3d1da04",

	fetchWeather: function(city){
		fetch(
			"https://api.openweathermap.org/data/2.5/weather?q=" + city + "&units=metric&lang=it&appid=" + this.apiKey,
			)
	...
	displayWeather: function(data){
		...
		document.querySelector(".wind").innerText = "Vento: " + speed + " m/s";
